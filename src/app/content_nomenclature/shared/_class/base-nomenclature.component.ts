...
import {NomenclatureP} from '../_interfaces/NomenclatureP.model'
...
export class BaseNomenclatureComponent implements OnInit {
  ...
  public onBackInNavBar() {
   // debugger
    ...
    this.router.navigateByUrl(this.parent_url+this.sharedVar.IdCategoria);
    else{
      ...
      this.repository.KatalogN(this._nomenclatures[0].katalogId).subscribe(
        d=>{
          ...
          this.router.navigateByUrl(this.parent_url+d.categoriaId);
